package com.roundcodebox.javadatatypes;
...
public class JavaIntExamples {
	...
	public static void main(String[] args) {
		...
		/*
		 * int is 32 bit signed type ranges from –2,147,483,648 to 2,147,483,647. int is
		 * also most commonly used integer type in Java. Declare int varibale as below
		 * 
